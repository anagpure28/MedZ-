          ...
          <Flex>
            ...
            <Box width={"75%"} padding={"10px"}>
              <Flex direction={"column"} rowGap={"10px"}>
                <Box>
                  <Image src="https://onemg.gumlet.io/4906c443-5dfa-4f87-b146-8adb1464a6e4_1679641908.png?w=1062&h=124&format=auto" />
                </Box>
                <Box>
                  <Image src="https://onemg.gumlet.io/056f4387-f3d0-423b-a439-7cb9680c2564_1673662712.jpg?w=1062&h=124&format=auto" />
                </Box>
              </Flex>
              <Flex
                direction={"row"}
